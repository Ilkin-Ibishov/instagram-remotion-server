                ...
                >
                    ...
                    <div
                        style={{
                            ...
                            inset: 0,
                            background:
                                'linear-gradient(135deg, rgba(255, 0, 0, 0.4) 0%, transparent 50%)',
                    ...
                    <div
                        style={{
                            ...
                            inset: 0,
                            background:
                                'linear-gradient(315deg, rgba(0, 80, 255, 0.4) 0%, transparent 50%)',
                            transform: 'translate(3px, 0)',
                            mixBlendMode: 'screen',
                        }}
                    />
            ...
            {effects.includes('halftone') && (
                <div
                    style={{
                        ...
                        backgroundImage: `url("data:image/svg+xml,%3Csvg width='8' height='8' viewBox='0 0 8 8' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='4' cy='4' r='1.5' fill='white'/%3E%3C/svg%3E")`,
